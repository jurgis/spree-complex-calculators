...
desc 'Generate documentation for the complex_calculators extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ComplexCalculatorsExtension'
...
desc 'Test the complex_calculators extension.'
...
namespace :test do
  desc 'Functional test the complex_calculators extension.'
  ...
  desc 'Unit test the complex_calculators extension.'
