class ComplexCalculatorsHooks < Spree::ThemeSupport::HookListener

  # Add a link on admin configuration page
  insert_after :admin_configurations_menu do
    %(<%= configurations_menu_item(t("complex_calculator_rates"), admin_complex_calculator_rates_path, t("complex_calculator_rates_description")) %>)
  end
  
  # Add js file to the head section
  insert_after :admin_inside_head, 'shared/complex_calculators_admin_head'
